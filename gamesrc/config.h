...
extern irr::scene::ISceneManager * the_smgr;
extern irr::video::IVideoDriver  * the_videoDriver;
extern irr::IrrlichtDevice       * the_device;
extern irr::core::dimension2d<irr::u32>   the_screensize;
