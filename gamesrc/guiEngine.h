...
/** GUIMainMenu specific implementation of TextDest used within guiFormSpecMenu */
class TextDestGUIMainMenu : public TextDest
{
public:
	/**
	 * default constructor
	 ...
	 */
	TextDestGUIMainMenu(GUIMainMenu* engine);
...
private:
	...
	GUIMainMenu* m_engine;
};

/** GUIMainMenu specific implementation of ISimpleTextureSource */
...
/** GUIMainMenu specific implementation of OnDemandSoundFetcher */
...
public:
	 ...
	 */
	GUIMainMenu(	irr::IrrlichtDevice* dev,
...
private:
	...
	TextDestGUIMainMenu*		m_buttonhandler;
	/** the formspec menu */
