...
void GUIDeathScreen::regenerateGui(v2u32 screensize)
{
	...
	*/
	
	{
		...
		rect = rect + v2s32(size.X/2-400/2, size.Y* 0.2);
		
		Environment->addStaticText(_("You died."), rect, false,
				true, this, 256);
		
	}
	{
        int w = screensize.X / 7;
        int h = screensize.Y * 0.07;
		core::rect<s32> rect(0, 0, w, h);
		rect = rect + v2s32(size.X/2-w/2, size.Y * 0.65);
