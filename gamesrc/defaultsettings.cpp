...
const char* default_game_name = "default";
...
void set_default_settings(Settings *settings)
{
    ...
    settings->setDefault("local_server_port", "30000");
    settings->setDefault("local_server_ip","");
	...
	settings->setDefault("keymap_toggle_time", "KEY_F5");
...
//	#endif
    ...
    settings->setDefault("inventory_2d", "false");
	...
	// Long press dig time, set 0 to disable
	settings->setDefault("touchscreen_dig_time", "300");
	settings->setDefault("touchscreen_dig_button", "true");
	...
	
    {
        ...
        settings->setDefault("font_size_percent", "34");
    }
	settings->setDefault("mono_font_size", "13");
	settings->setDefault("fallback_font_path", porting::getDataPath("fonts" DIR_DELIM "liberationsans.ttf"));
	settings->setDefault("fallback_font_size", "13");
    settings->setDefault("mono_font_path", porting::getDataPath("fonts" DIR_DELIM "liberationsans.ttf"));
#else
//    assert(0);
...
//	settings->setDefault("mono_font_path", porting::getDataPath("fonts" DIR_DELIM "fontdejavusansmono.png"));
	...
	settings->setDefault("curl_timeout", "15000");
    ...
    settings->setDefault("left_click_check_time", "700");
    settings->setDefault("right_click_check_time", "300");
    //如果是低清的屏幕。这些特效默认关闭
    if (the_screensize.Width <= 810 && the_screensize.Height <= 810 ) {
