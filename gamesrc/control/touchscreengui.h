...
private:
	...
	u32 m_hud_start_y;
	u32 m_buttons_start_x;
	bool m_visible; // is the gui visible
	bool m_visible_buttons;

	bool m_double_click;
	int m_previous_click_time;
	u32 m_previous_key_time;
	u32 m_previous_place_time;
	u16 m_dig_press_time;
};
#endif
