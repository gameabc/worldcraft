...
playerdata = load_player_data()
	...
	if creative_type == "search" then
		...
		CREATIVE_SEARCH_ITEMS = "invsize[14,9.75;]"..
			"button[9.2,0;1.8,1;creative_search;Search]"..
			"list[current_player;main;0.5,7;9,1;]"..
			"list[detached:creative;main;0.5,2.5;9,4;"..tostring(start_i).."]"..
			"label[7.25,1.6;"..tostring(pagenum).."/"..tostring(pagemax).."]"..
			"button[5.5,1.5;1.5,0.8;creative_prev;<<]"..
			"button[8,1.5;1.5,0.8;creative_next;>>]"..
            "label[0.3,8.5;Inventory show wrong?   try to enable the '2D inventory' option in the setting tab]" ..
			"button[7.1,0;1.8,1;creative_survival;Survival]"
